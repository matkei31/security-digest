...
- **優先度:** P1
- **状態:** Version 1.0承認済み / PR #46 merge待ち
- **出所種別:** ユーザー承認済み方針
...
- **残作業:** [PR #46](https://github.com/matkei31/security-digest/pull/46)のmergeとmerge後の客観確認のみ。merge前のためBL-024は完了扱いにしない。
