...
- **残作業:** merge前なのでBL-026は未完了。残作業はPR #50のReady化とmerge、[SECURITY_REQUIREMENTS.md](SECURITY_REQUIREMENTS.md)のVersion 1.3としてのSR-025／SR-028／SR-029およびGAP-002／GAP-003／GAP-004の最終状態更新、BL-026 closure記録。
