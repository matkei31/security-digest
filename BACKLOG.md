...
- **残作業:** BL-032による`content_usage_mode`実装とfetch.py enforcement、BL-009によるAbout/出典/訂正窓口の実装、Google TAG利用規約の2026-07-30改定後の再確認、Cisco Talos規約適用範囲の確認、Krebs on Securityの公式terms確認。
