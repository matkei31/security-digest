...
[BL-020](BACKLOG.md#bl-020--収集元一覧の取得元別カラーを廃止する) is implemented in a Draft PR and awaits user visual acceptance, so it is not ranked as an implementation candidate.
