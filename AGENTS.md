...
- [SECURITY_REQUIREMENTS.md](SECURITY_REQUIREMENTS.md) Version 1.1 is the source of truth for the current architecture security baseline, accepted residual risks, and re-evaluation triggers.
