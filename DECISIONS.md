...
- **ID:** SD-013
- **Date:** 2026-07-17
- **Status:** Accepted / Implemented (implementation pending the user's visual PC/390px acceptance; see [BL-002](BACKLOG.md#bl-002--記事カードの楕円バッジ多用を見直す)/[BL-003](BACKLOG.md#bl-003--aiで機械処理された印象を弱める))
