...
- **ID:** SD-020
- **Date:** 2026-07-23
- **Status:** Accepted / Implemented locally / Awaiting production
...
- **Evidence:** [BL-022](BACKLOG.md#bl-022--前日ダイジェスト直接リンク); [UI_SPEC.md](UI_SPEC.md) Version 1.1; [`fetch.py`](fetch.py); [`test_archive.py`](test_archive.py); repository-external BL-022 offline screening artifacts.
