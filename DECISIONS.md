...
- **Evidence:** [BL-020](BACKLOG.md#bl-020--収集元一覧の取得元別カラーを廃止する); [UI_SPEC.md](UI_SPEC.md) Version 1.3; [`fetch.py`](fetch.py); [`test_archive.py`](test_archive.py); PC 1280px／390px top-page and daily-Archive screenshots stored outside the repository; [Draft PR #41](https://github.com/matkei31/security-digest/pull/41) and Pull Request CI.
