...
- **ID:** SD-021
- **Date:** 2026-07-24
- **Status:** Accepted / Implemented locally / Awaiting production verification
...
- **Evidence:** [BL-022](BACKLOG.md#bl-022--前日ダイジェスト直接リンク); [UI_SPEC.md](UI_SPEC.md) Version 1.2; [`fetch.py`](fetch.py); [`test_archive.py`](test_archive.py).
