...
- **ID:** SD-023
- **Date:** 2026-07-24
- **Status:** Accepted / Implemented locally and user-accepted; merge and public verification pending
...
- **Evidence:** [BL-020](BACKLOG.md#bl-020--収集元一覧の取得元別カラーを廃止する); [UI_SPEC.md](UI_SPEC.md) Version 1.3; [`fetch.py`](fetch.py); [`test_archive.py`](test_archive.py); repository-external PC 1280px／390px top-page and daily-Archive screenshots; [Draft PR #41](https://github.com/matkei31/security-digest/pull/41) and Pull Request CI. The user visually accepted those pre-merge generated screenshots with 「この表示でOK、進めて」, including the three-column PC display, one-column 390px display, neutral plain-text treatment, and browser-default focus indication. Public Pages verification remains a post-merge objective check; this evidence does not state that the user reviewed the public site.
