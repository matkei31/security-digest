...
This Version adds new SR-047 and new GAP-018 (see below); it does not change SR-001–SR-046,
GAP-001–GAP-017, or any Version 1.0–1.6 history. This Version's own Draft status means none of
...
(this Version) is a **Draft** maintenance update layered on top of that Approved Version 1.5
baseline; until the user reviews and accepts it, only Version 1.5 is approved policy, and
Version 1.6's new or changed material (see below) is not. Version 1.5's own approval is recorded
