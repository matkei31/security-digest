...
class Batch2DocumentationConsistencyTest(unittest.TestCase):
    ...
    def test_bl_019_completion_and_bl_020_registration(self):
        ...
        self.assertIn("- **状態:** 実装済み / ユーザー受入済み / Pages公開確認待ち", bl020_text)
        ...
        self.assertIn("[Draft PR #41](https://github.com/matkei31/security-digest/pull/41)", bl020_text)
        ...
        self.assertIn("PCの3列、390pxの1列", bl020_text)
        self.assertIn("browser標準focus表示", bl020_text)
        self.assertIn("ユーザーが公開production Pagesを確認したことを意味しない", bl020_text)
        self.assertIn("mergeとPages公開確認", bl020_text)
        ...
        self.assertNotIn("[BL-022]", next_candidates)
        self.assertIn("pre-merge generated PC 1280px／390px screenshots", known_issues)
        self.assertIn("「この表示でOK、進めて」", known_issues)
        self.assertIn("merge and objective Pages verification remain pending", known_issues)
        self.assertIn("production remains unchanged", known_issues)
        self.assertIn("implemented and user-accepted in [PR #41]", next_candidates)
        self.assertIn("awaits merge and objective Pages verification", next_candidates)
        ...
        self.assertIn("- **Status:** Accepted / Implemented locally and user-accepted; merge and public verification pending", sd023)
        ...
        self.assertIn("[Draft PR #41](https://github.com/matkei31/security-digest/pull/41)", sd023)
        self.assertIn("「この表示でOK、進めて」", sd023)
        self.assertIn("Public Pages verification remains a post-merge objective check", sd023)
        self.assertIn("does not state that the user reviewed the public site", sd023)
