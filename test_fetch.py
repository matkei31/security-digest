...
class Batch2DocumentationConsistencyTest(unittest.TestCase):
    ...
    def test_bl_ids_are_unique_and_cover_bl001_to_bl032(self):
        ...
        self.assertEqual(set(ids), {f"BL-{n:03d}" for n in range(1, 33)})

    def test_sd_ids_are_unique_and_cover_sd001_to_sd030(self):
        ...
        self.assertEqual(set(ids), {f"SD-{n:03d}" for n in range(1, 31)})
