...
class Batch2DocumentationConsistencyTest(unittest.TestCase):
    ...
    def test_bl_019_completion_and_bl_020_registration(self):
        ...
        self.assertNotIn("[BL-022]", next_candidates)
        self.assertIn("implemented in [Draft PR #41]", known_issues)
        self.assertIn("implemented in [Draft PR #41]", next_candidates)
        self.assertIn("and awaits user visual acceptance", known_issues)
        self.assertIn("and awaits user visual acceptance", next_candidates)
